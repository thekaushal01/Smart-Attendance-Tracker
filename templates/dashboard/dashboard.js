...
// ===== PAGE TRANSITION ANIMATION (DASHBOARD TO LANDING) =====
...
function createTransitionOverlay() {
    ...
    overlay.innerHTML = `
        ...
        <div class="transition-content">
            <h2 class="transition-title">Returning to Home</h2>
            ...
            <div class="transition-graph-container">
                <div class="transition-graph">
                    <svg viewBox="0 0 400 200" style="width: 100%; height: 100%;">
                        ...
                        <!-- Graph Path (reversed for return journey) -->
                        <path class="graph-path" d="M 360 10 Q 320 20, 240 50 T 160 80 T 80 120 Q 60 140, 0 160" />
                        
                        <!-- Fill area under graph -->
                        <path class="graph-fill" d="M 360 10 Q 320 20, 240 50 T 160 80 T 80 120 Q 60 140, 0 160 L 0 180 L 360 180 Z" />
                    </svg>
                    ...
                    <div class="graph-axis">
                        ...
                        <!-- X-axis labels -->
                        <span class="graph-label-x" style="left: 0;">Start</span>
                        <span class="graph-label-x" style="left: 33%;">Progress</span>
                        <span class="graph-label-x" style="left: 66%;">Growing</span>
                        <span class="graph-label-x" style="right: 0;">Success</span>
                    </div>
            ...
            <div class="transition-insights">
                <div class="insight-item">
                    ...
                    <div class="insight-text">
                        Your attendance journey matters for success
                    </div>
                </div>
                <div class="insight-item">
                    <div class="insight-icon">
                    ...
                    <div class="insight-text">
                        Stay consistent to reach your academic goals
                    </div>
                </div>
                <div class="insight-item">
                    <div class="insight-icon">
                    ...
                    <div class="insight-text">
                        Every class attended is a step forward
                    </div>
                </div>
            </div>
...
// Initialize transition for back button
